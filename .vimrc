...
Plug 'jiangmiao/auto-pairs' " Plugin for auto close brakets
Plug 'tpope/vim-commentary' " Plugin for comment code
...
function! CPPSET()
    ...
    nnoremap <buffer> <F8> :w<cr>:!g++-12 -DLOCAL_DEBUG -fsplit-stack -Wall -Wextra -Wshadow -O2 -fsanitize=address % -o %< -std=c++17 -I ./<cr>
endfunction
autocmd FileType cpp call CPPSET()
autocmd BufNewFile *.cpp 0r ~/cpp/cp_template.cpp
" }}}
